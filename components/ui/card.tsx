...
const cardVariants = cva("w-full relative p-6", {
  variants: {
    variant: {
      default: [
        "border rounded-lg",
      ...
      return (
        <>
          ...
          <div className="relative w-full border-x border-zinc-400 dark:border-zinc-700">
            ...
            <div className="relative z-20 mx-auto py-4">
              <CardContent>
                {title && (
    ...
    const PlusIcons = () => (
      <>
        <svg
          ...
          strokeWidth="1"
          stroke="currentColor"
          className="dark:text-zinc-500 text-black size-6 absolute -top-3 -left-3"
        >
          <path
            strokeLinecap="round"
        ...
        <svg
          ...
          strokeWidth="1"
          stroke="currentColor"
          className="dark:text-zinc-500 text-black size-6 absolute -top-3 -right-3"
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        <svg
          ...
          strokeWidth="1"
          stroke="currentColor"
          className="dark:text-zinc-500 text-black size-6 absolute -bottom-3 -left-3"
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        <svg
          ...
          strokeWidth="1"
          stroke="currentColor"
          className="dark:text-zinc-500 text-black size-6 absolute -bottom-3 -right-3"
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
...
export { Card, CardContent, cardVariants, CardFooter, CardHeader, CardDescription, CardTitle }
